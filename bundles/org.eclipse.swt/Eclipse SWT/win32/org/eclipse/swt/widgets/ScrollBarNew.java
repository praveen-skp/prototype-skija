 ...
 */
public class ScrollBarNew extends Widget {
	ScrollableNew parent;
 ...
 * @see Widget#getStyle
 */
ScrollBarNew(ScrollableNew parent, int style) {
 ...
 * </ul>
 */
public ScrollableNew getParent() {
	checkWidget();
	return parent;
}
 ...
 * comprises the areas 2, 3, and 4 as described in {@link ScrollBarNew}.
 *
