...
//		}
		 ...
		 * WM_VSCROLL or WM_HSCROLL to do the actual scrolling. This depends on the
		 * implementation of each native widget. In order to ensure that application
		 * code is notified when the scroll bar moves, compare the scroll bar position
		 * before and after the WM_MOUSEWHEEL. If the native control sends a WM_VSCROLL
