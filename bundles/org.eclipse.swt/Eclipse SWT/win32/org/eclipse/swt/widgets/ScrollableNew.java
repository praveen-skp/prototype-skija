 ...
 */
public abstract class ScrollableNew extends Control {
	ScrollBarNew horizontalBar, verticalBar;
 ...
 * @see Widget#getStyle
 */
public ScrollableNew (Composite parent, int style) {
	super (parent, style);
}
...
ScrollBarNew createScrollBar(int type) {
	ScrollBarNew bar = new ScrollBarNew(this, type);
	if ((state & CANVAS) != 0) {
		bar.setMaximum (100);
		bar.setThumb (10);
	}
 ...
 * </ul>
 */
public ScrollBarNew getHorizontalBar() {
	checkWidget ();
 ...
 * </ul>
 */
public ScrollBarNew getVerticalBar() {
	checkWidget ();
	return verticalBar;
}
...
//		}
//
//		ScrollBarNew bar = vertical ? verticalBar : horizontalBar;
