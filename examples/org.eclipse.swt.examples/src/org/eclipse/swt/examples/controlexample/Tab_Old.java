 ...
 */
abstract class Tab_Old {
	Shell shell;
	Display display;

	Button_Old borderButton;
	/* Common control buttons */
	Button enabledButton, visibleButton, backgroundImageButton, popupMenuButton;
	...
	final ControlExample_Old instance;
...
//		new EventInfo ("Settings", SWT.Settings, 0, 0, new Event()),  // note: this event only goes to Display
	 ...
	 */
	Tab_Old(ControlExample_Old instance2) {
