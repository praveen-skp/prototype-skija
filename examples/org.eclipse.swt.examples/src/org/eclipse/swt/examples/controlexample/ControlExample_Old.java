...
public class ControlExample_Old {
	 ...
	 */
	public ControlExample_Old(Composite parent) {
		initResources();
	...
	Tab_Old[] createTabs() {
		return new Tab_Old [] {
//			new ButtonTab_Old (this),
			new ListTab_Old (this),
		};
	}
	 ...
	 */
	void initResources() {
		final Class<ControlExample_Old> clazz = ControlExample_Old.class;
	...
	public static void main(String[] args) {
		...
		ControlExample_Old instance = new ControlExample_Old(shell);
