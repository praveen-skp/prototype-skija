...
import org.eclipse.swt.widgets.List_Old;
import org.eclipse.swt.widgets.Widget;

class ListTab_Old extends ScrollableTab_Old {
	 ...
	 */
	ListTab_Old(ControlExample_Old instance) {
		super(instance);
	}
	...
	void createExampleWidgets () {
		...
		list1 = new List_Old (listGroup, style);
